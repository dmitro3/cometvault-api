...
// const BSC_VAULTS_ENDPOINT =
  // 'https://raw.githubusercontent.com/krypto-dev/comet-autovault/master/src/features/configure/vault/bsc_pools.js';
...
const FANTOM_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/krypto-dev/comet-autovault/master/src/features/configure/vault/fantom_pools.js';
...
const EXCLUDED_IDS_FROM_TVL = ['fantom-bifi-gov'];
